...
<div class="main-container" style="max-width: 800px;">
    <div class="glass-card">
        <div class="page-header-block">
            <h2><i class="bi bi-pencil-square" style="color: #10b981;"></i> 编辑图书信息</h2>
            <a href="${pageContext.request.contextPath}/admin/book" class="btn btn-secondary">
                <i class="bi bi-arrow-left"></i> 返回列表
            </a>
        </div>

        <form action="${pageContext.request.contextPath}/book?action=update" method="post">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        <input type="text" name="isbn" value="${book.isbn}" required placeholder="例如：978-7-111-11111-1" style="padding-left: 40px;">
                ...
                <div class="form-group">
                    <label>书名 *</label>
                    <div style="position: relative;">
                        <input type="text" name="title" value="${book.title}" required placeholder="请输入书名" style="padding-left: 40px;">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label>作者 *</label>
                    <div style="position: relative;">
                        <input type="text" name="author" value="${book.author}" required placeholder="请输入作者" style="padding-left: 40px;">
                ...
                <div class="form-group">
                    <label>出版社 *</label>
                    <div style="position: relative;">
                        <input type="text" name="publisher" value="${book.publisher}" required placeholder="请输入出版社" style="padding-left: 40px;">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label>出版日期</label>
                    <div style="position: relative;">
                        <input type="date" name="publishDate" value="${book.publishDate}" style="padding-left: 40px;">
                    ...
                    <div style="position: relative;">
                        <select name="categoryId" required style="padding-left: 40px; appearance: none; -webkit-appearance: none;">
                            ...
                            <c:forEach var="cat" items="${categories}">
                                <option value="${cat.id}" ${cat.id == book.categoryId ? 'selected' : ''}>${cat.categoryName}</option>
                            </c:forEach>
                        </select>
            ...
            <div class="form-row">
                <div class="form-group">
                    <label>总数量 *</label>
                    <div style="position: relative;">
                        <input type="number" name="totalCount" value="${book.totalCount}" required min="1" style="padding-left: 40px;">
                ...
                <div class="form-group">
                    <label>可借数量 *</label>
                    <div style="position: relative;">
                        <input type="number" name="availableCount" value="${book.availableCount}" required min="0" style="padding-left: 40px;">
            ...
            <div class="form-group">
                <label>存放位置</label>
                <div style="position: relative;">
                    <input type="text" name="location" value="${book.location}" placeholder="例如：A区书架-102" style="padding-left: 40px;">
                    <i class="bi bi-geo-alt" style="position: absolute; left: 14px; top: 12px; color: var(--text-muted); font-size: 16px;"></i>
                </div>
            </div>
            
            <div style="margin-top: 30px; display: flex; gap: 12px;">
                <button type="submit" class="btn btn-success" style="flex: 1; height: 46px;">
